...
import com.ilnodstudio.ansartelecom.databinding.FragmentCaseBinding
...
class CaseFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentCaseBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    ...
    private fun downloadPowerbankProducts() {
        ...
        val powerbankSnapshot = accessoriesSnapshot.child("Чехлы")
