...
import com.ilnodstudio.ansartelecom.databinding.FragmentAzercellBinding
...
class AzercellFragment : Fragment() {
    lateinit var binding: FragmentAzercellBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAzercellBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    ...
    private fun downloadPowerbankProducts() {
        ...
        val accessoriesSnapshot = ansarSnapshot.child("Сим-Карты")
        val powerbankSnapshot = accessoriesSnapshot.child("Azercell")
