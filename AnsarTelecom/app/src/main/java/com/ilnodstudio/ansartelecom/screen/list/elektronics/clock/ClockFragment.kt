package com.ilnodstudio.ansartelecom.screen.list.elektronics.clock
...
import com.ilnodstudio.ansartelecom.databinding.FragmentClockBinding
...
class ClockFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentClockBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    ...
    private fun downloadPowerbankProducts() {
        ...
        val powerbankSnapshot = accessoriesSnapshot.child("Часы")
