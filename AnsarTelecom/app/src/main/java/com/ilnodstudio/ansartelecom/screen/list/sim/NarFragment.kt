...
import com.ilnodstudio.ansartelecom.databinding.FragmentNarBinding
...
class NarFragment : Fragment() {
    lateinit var binding: FragmentNarBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentNarBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    ...
    private fun downloadPowerbankProducts() {
        ...
        val powerbankSnapshot = accessoriesSnapshot.child("Nar")
