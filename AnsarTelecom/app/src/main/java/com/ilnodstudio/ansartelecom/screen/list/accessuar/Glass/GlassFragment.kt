...
import com.ilnodstudio.ansartelecom.databinding.FragmentGlassBinding
...
class GlassFragment : Fragment() {
    lateinit var binding: FragmentGlassBinding
    ...
    private fun downloadPowerbankProducts() {
        ...
        val powerbankSnapshot = accessoriesSnapshot.child("Защитные стекла")
