...
import com.ilnodstudio.ansartelecom.databinding.FragmentBakcellBinding
...
class BakcellFragment : Fragment() {
    lateinit var binding: FragmentBakcellBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBakcellBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    ...
    private fun downloadPowerbankProducts() {
        ...
        val powerbankSnapshot = accessoriesSnapshot.child("Bakcell")
