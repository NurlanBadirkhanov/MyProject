...
class PowerBankFragment : Fragment() {
    lateinit var binding:FragmentPowerBankBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPowerBankBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    ...
    private fun downloadPowerbankProducts() {
        ...
        val powerbankSnapshot = accessoriesSnapshot.child("ПоверБанки")
