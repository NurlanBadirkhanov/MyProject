package com.ilnodstudio.ansartelecom.screen.list.accessuar.Adapters
...
import com.ilnodstudio.ansartelecom.databinding.FragmentAdapterBinding
...
class AdapterFragment : Fragment() {
    lateinit var binding: FragmentAdapterBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAdapterBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    ...
    private fun downloadPowerbankProducts() {
        ...
        val powerbankSnapshot = accessoriesSnapshot.child("Адаптеры")
