...
class UsbFragment : Fragment() {
    lateinit var binding:FragmentUsbBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentUsbBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    ...
    private fun downloadPowerbankProducts() {
        ...
        val powerbankSnapshot = accessoriesSnapshot.child("USB-Шнуры")
