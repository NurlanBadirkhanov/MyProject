package com.ilnodstudio.ansartelecom.screen.list.elektronics.headphones
...
import com.ilnodstudio.ansartelecom.databinding.FragmentHeadphonesBinding
...
class HeadphonesFragment : Fragment() {
    lateinit var binding: FragmentHeadphonesBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentHeadphonesBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    ...
    private fun downloadPowerbankProducts() {
        ...
        val powerbankSnapshot = accessoriesSnapshot.child("Наушники")
