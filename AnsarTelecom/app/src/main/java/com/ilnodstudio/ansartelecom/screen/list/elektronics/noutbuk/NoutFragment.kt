package com.ilnodstudio.ansartelecom.screen.list.elektronics.noutbuk
...
import com.ilnodstudio.ansartelecom.databinding.FragmentNoutBinding
...
class NoutFragment : Fragment() {
    lateinit var binding:FragmentNoutBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentNoutBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    ...
    private fun downloadPowerbankProducts() {
        ...
        val powerbankSnapshot = accessoriesSnapshot.child("Ноутбуки")
