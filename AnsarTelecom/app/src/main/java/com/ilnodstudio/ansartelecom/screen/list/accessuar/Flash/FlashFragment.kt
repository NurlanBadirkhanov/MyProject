...
import com.ilnodstudio.ansartelecom.databinding.FragmentFlashBinding
...
class FlashFragment : Fragment() {
    lateinit var binding: FragmentFlashBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentFlashBinding.inflate(layoutInflater,container,false)
        return binding.root
    }
    ...
    private fun downloadPowerbankProducts() {
        ...
        val powerbankSnapshot = accessoriesSnapshot.child("Флеш карты")
