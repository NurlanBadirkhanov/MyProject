...
import com.azerbaijankiraye.kirayeaz.databinding.FragmentAllWordBinding
...
class AllWordFragment : Fragment() {
    ...
    private fun getFirebase() {
        ...
        fetchProductsFromCategory(c1, powerbankProducts)
        ...
        fetchProductsFromCategory(c1Z, powerbankProducts)
