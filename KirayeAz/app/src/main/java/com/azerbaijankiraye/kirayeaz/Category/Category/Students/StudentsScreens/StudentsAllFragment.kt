package com.azerbaijankiraye.kirayeaz.Category.Category.Students.StudentsScreens
...
import com.azerbaijankiraye.kirayeaz.databinding.FragmentStudentsAllBinding


class StudentsAllFragment : Fragment() {
    private lateinit var binding:FragmentStudentsAllBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentStudentsAllBinding.inflate(layoutInflater,container,false)
        return binding.root
    ...
    private fun getFirebase() {
        ...
        val students1 = reference.child("Для студентов").child("Ищу Квартиру")
        val students2 = reference.child("Для студентов").child("Сдаю Квартиру")
        ...
        fetchProductsFromCategory(students2, powerbankProducts)
