...
import com.azerbaijankiraye.kirayeaz.databinding.FragmentHomeHouseBinding
import com.google.firebase.database.*

class HomeHouseFragment : Fragment() {
    lateinit var binding: FragmentHomeHouseBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentHomeHouseBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
