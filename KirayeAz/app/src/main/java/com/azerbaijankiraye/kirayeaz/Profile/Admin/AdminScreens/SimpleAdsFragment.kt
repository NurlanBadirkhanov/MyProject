...
import com.azerbaijankiraye.kirayeaz.Profile.Admin.Details.SimpleDetailActivity
import com.azerbaijankiraye.kirayeaz.UsersDataMy
import com.azerbaijankiraye.kirayeaz.databinding.FragmentSimpleAdsBinding


class SimpleAdsFragment : Fragment() {
    private lateinit var binding: FragmentSimpleAdsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSimpleAdsBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    private fun initRc() {
        ...
        adapter.onItemClick = { adminData ->
            val intent = Intent(requireContext(), SimpleDetailActivity::class.java)
    ...
    private fun getDataFirebase() {
        ...
        val salesReference = reference.child("adminSimple")
